...
<div class="main-container">
    <div class="card-box pd-20 height-100-p mb-30">
        <div class="row align-items-center mb-20">
            <div class="col-sm-7">
                <h4> <span class="ti-bookmark-alt"></span> Data Calon Peserta</h4>
                <div class="cabang-top"><?= $this->session->userdata("nama_cabang") ?></div>
            </div>
            <div class="col-sm-5 text-lg-right">
                <a href="<?= base_url("pmb/formulir") ?>" class="btn  btn-primary btn-m "><i class="fa fa-plus-circle"></i> Baru </a>
        ...
        <div style="background-color:#e9e9e9; padding:5px 10px; border-radius:6px; margin-bottom:10px SortirDataInput ">
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1" style="width: 160px;">Nama Unit </span>
                </div>
                <div class="col-sm-6">
