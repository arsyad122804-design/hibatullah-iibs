            ...
            <div class="input-group mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    <select name="Periode_Chek" id="Periode_Chek" class="form-control">
                        ...
                        <!-- <1?php foreach ($dt_periode as $dp) : ?>
                            <1?php ($periodesctiv->id_tahun == $dp->id_tahun) ? $aktif = 'selected' : $aktif = "" ?>
                            <option value="<1?= $dp->id_tahun ?>" <1?= $aktif ?>><1?= $dp->tahun_akademik ?></option>
                        <1?php endforeach; ?> -->
                    </select>
                </div>
            </div>
