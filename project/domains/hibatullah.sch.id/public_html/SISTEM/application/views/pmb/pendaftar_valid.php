...
<div class="main-container">
    <div class="card-box pd-20 height-100-p mb-30">
        <div class="row align-items-center mb-20">
            <div class="col-sm-7">
                <h4> <span class="ti-bookmark-alt"></span> Data Lunas Tes Seleksi</h4>
                <div class="cabang-top"><?= $this->session->userdata("nama_cabang") ?></div>
            </div>
            <div class="col-sm-5 text-lg-right">
                <!-- <button type="button" class="btn  btn-primary openform btn-m" data-id="new" data-option="New"> <i class="fa fa-upload"></i> Migrasi Data</button> -->
        ...
        <div style="background-color:#e9e9e9; padding:5px 10px; border-radius:6px; margin-bottom:10px SortirDataInput ">
            ...
            <div class="input-group mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    <?php $dt_periode = $this->db->query("SELECT * FROM master_pmb_tahun_akademik ORDER BY tahun_akademik ASC")->result(); ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12 table-responsive">
                        ...
                        <thead>
                            <tr>
                                <th class="check" style="width: 40px;">
                                    <input type="checkbox" id="CheckAll_Lulus" value="" />&nbsp;All
                                </th>
                                <th></th>
                                <th>Nama Lengkap</th>
                                <th>Gender</th>
                    ...
                    <div class="mt-3">* Proses data centang</div>
                    <div class="input-group mb-1">
                        <div id="radioBtnAll" class="btn-group text-white font-weight-bold bg-primary rounded">
                            <a class="btn btn-info Btn_AllSet btn-sm" data-val="3" data-pro="Proses Pending">Pending</a>
                            <a class="btn btn-primary Btn_AllSet  btn-sm" data-val="5" data-pro="Proses Lulus">Lulus</a>
                            <a class="btn btn-danger Btn_AllSet btn-sm" data-val="4" data-pro="Proses Tidak Lulus">Tidak Lulus</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade FormOpenMigrasi" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 style="color: aliceblue;"><span class="options">Migrasi Data Peserta</span> </h5>
                    <button type="button" class="close " data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                <div class="modal-body">
                    <?= form_open("pmb_api/pendaftar_valid/migrasidata", array('id' => 'migrasi')); ?>
                    <div class="input-group mb-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1" style="width: 160px;">Nama Cabang </span>
                        </div>
                        <div class="col-sm-6">
                            <?php $dtcabang = $this->db->get("data_kantor_cabang")->result(); ?>
                            <select name="Cabang_id" id="Cabang" class="form-control Cabang">
                                <option value="">-Pilih Cabang-</option>
                                <?php foreach ($dtcabang as $dc) : ?>
                                    <option value="<?= $dc->id ?>"><?= $dc->nama_cabang ?></option>
                                <?php endforeach; ?>
                    ...
                    <div class="input-group mb-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1" style="width: 160px;">Periode Pendftaran </span>
                        </div>
                        <div class="col-sm-6">
                            <?php $dt_periode = $this->db->query("SELECT * FROM master_pmb_tahun_akademik ORDER BY id_tahun DESC")->result(); ?>
                            <select name="Periode_id" id="Periode" class="form-control Periode">
                                <!-- <option value="">-Pilih Periode-</option> -->
                                <?php foreach ($dt_periode as $dp) : ?>
                    ...
                    <div class="col-md-12 my-5 Dt_Migrasi">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-sm-12" style=" text-align:right ">
                                ...
                                <input type="submit" class="btn btn-primary btn-lg " id="new_Akademik_p" value="Proses Migrasi">
                            </div>
                        </div>
                    </div>
                    <?= form_close(); ?>
