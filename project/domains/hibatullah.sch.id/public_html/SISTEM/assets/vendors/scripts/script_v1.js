...
jQuery(document).ready(function () {
  ...
  $(".dateset-control-range").daterangepicker({
    ...
    locale: {
      ...
      weekLabel: "W",
      daysOfWeek: ["Aha", "Sen", "Sel", "Rab", "Kam", "Jum", "Sab"],
      monthNames: [
        "January",
        "February",
        "March",
  ...
  $(".dateset-control").daterangepicker({
  ...
  $(".dateset-control-range-page").daterangepicker({
    singleDatePicker: false,
    showDropdowns: true,
    autoApply: false,
    locale: {
  ...
  $(".dateset-control-page").daterangepicker({
    singleDatePicker: true,
    showDropdowns: true,
    autoApply: true,
    locale: {
